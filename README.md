...
- Completed
  - Generate synthetic data with specifiable number of datapoints and number of features
- Ongoing
  - Implement PCA algorithms
- Future Work
  - Test correctness of PCA algorithms
  - Evaluate theoretical time and space complexity
  - Measure numerical stability and sensitivity to noise
  - Measure actual runtime and memory usage
  - Visualise scaling behaviour
